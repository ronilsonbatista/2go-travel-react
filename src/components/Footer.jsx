...
export default function Footer({ onNavigate, onOpenDownload }) {
  return (
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        ...
        <div className="flex flex-col gap-6">
          <button 
            ...
            className="flex items-center text-left font-headers text-2xl font-extrabold tracking-tight text-brand-navy relative cursor-pointer w-fit"
          >
            2GO
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 list-none">
            <li>
              <button onClick={() => onNavigate('about')} className="text-sm text-text-muted hover:text-brand-orange transition-colors cursor-pointer text-left">
                Sobre nós
              </button>
            </li>
            <li>
              <button onClick={() => onNavigate('blog')} className="text-sm text-text-muted hover:text-brand-orange transition-colors cursor-pointer text-left">
                Blog editorial
              </button>
            </li>
            <li>
              <button onClick={() => onNavigate('contact')} className="text-sm text-text-muted hover:text-brand-orange transition-colors cursor-pointer text-left">
                Trabalhe conosco
              </button>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 list-none">
            <li>
              <button onClick={() => onNavigate('planner')} className="text-sm text-text-muted hover:text-brand-orange transition-colors cursor-pointer text-left">
                Gerar Roteiro
              </button>
            </li>
            <li>
              <button onClick={() => onNavigate('home', 'destinos')} className="text-sm text-text-muted hover:text-brand-orange transition-colors cursor-pointer text-left">
                Destinos Curados
              </button>
            </li>
            <li>
