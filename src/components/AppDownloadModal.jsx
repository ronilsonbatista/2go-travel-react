  ...
  return (
    ...
    >
      <div className="relative bg-white border border-border-gray max-w-[500px] w-full p-8 md:p-10 rounded-[28px] text-center flex flex-col items-center shadow-xl animate-fade-in-up">
        ...
        {/* Brand Logo */}
        <div className="font-headers text-3xl font-extrabold tracking-tight mb-4 text-brand-navy">
          2GO
        </div>
        ...
        <div className="bg-bg-light p-5 rounded-2xl mb-8 border border-border-gray flex flex-col items-center justify-center w-full max-w-[240px]">
          <div 
            className="w-36 h-36 border border-border-gray bg-white rounded-xl flex items-center justify-center relative shadow-sm"
            style={{
              background: 'radial-gradient(circle, #081B6B 0%, #F7F8FA 100%)'
            }}
          >
            {/* Grid pattern mimicking QR code */}
            ...
            {/* Center icon badge */}
            <div className="bg-brand-navy text-white font-headers font-extrabold text-xs px-3 py-1.5 rounded-md shadow-md z-10 border border-white/20">
              2GO
            </div>
          </div>
